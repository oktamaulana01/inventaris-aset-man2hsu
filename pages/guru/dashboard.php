...
<div class="card mb-4 animate-fadeInUp">
    <div class="card-body" style="padding: 28px;">
        <div style="display:flex; align-items:center; gap:20px; flex-wrap:wrap;">
            ...
            <a href="/inventaris-aset-man2hsu/pages/guru/pinjam.php" class="btn btn-primary">
...
<div class="card mb-4 animate-fadeInUp">
    <div class="card-header">
        ...
        <a href="/inventaris-aset-man2hsu/pages/guru/riwayat.php" class="btn btn-sm btn-secondary">Lihat Semua</a>
    </div>
    <div class="card-body">
...
<div class="card animate-fadeInUp">
    <div class="card-header">
        ...
        <a href="/inventaris-aset-man2hsu/pages/guru/katalog.php" class="btn btn-sm btn-secondary">Lihat Katalog</a>
    </div>
    <div class="card-body">
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td><?= $a['jumlah'] ?></td>
                            <td>
                                <a href="/inventaris-aset-man2hsu/pages/guru/pinjam.php?id_aset=<?= $a['id'] ?>" class="btn btn-sm btn-primary">
