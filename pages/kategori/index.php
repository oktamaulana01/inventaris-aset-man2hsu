...
<div class="page-header">
    <div>
        ...
        <div class="breadcrumb">
            <a href="<?= BASE_URL ?>/dashboard">Dashboard</a><span class="separator">/</span><span>Kategori</span>
        </div>
    </div>
    <a href="<?= BASE_URL ?>/kategori/tambah" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Kategori</a>
</div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="<?= BASE_URL ?>/kategori/edit?id=<?= $k['id'] ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                <a href="javascript:void(0)" onclick="confirmDelete('Hapus kategori <?= htmlspecialchars($k['nama_kategori'], ENT_QUOTES) ?>?', '<?= BASE_URL ?>/pages/kategori/hapus.php', '<?= $k['id'] ?>')" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                            </div>
                        </td>
                    </tr>
