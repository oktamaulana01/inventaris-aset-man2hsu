...
<head>
    ...
    <style>
        ...
        ol.klausul-list { margin-left: 24px; margin-bottom: 8px; font-size: 9.5pt; }
        ol.klausul-list li { margin-bottom: 3px; }
        .table-ttd { width: 100%; border-collapse: collapse; margin-top: 15px; font-size: 9.5pt; }
...
<body>
    ...
    <div class="ba-content">
        ...
        <table class="table-pihak">
            ...
            <tr>
                <td colspan="3" style="font-style:italic;">Selaku pihak yang menyerahkan barang, selanjutnya disebut <strong>PIHAK PERTAMA</strong>.</td>
            </tr>
        </table>
        ...
        <table class="table-pihak" style="margin-top:4px;">
            ...
            <tr>
                <td colspan="3" style="font-style:italic;">Selaku pihak yang menerima dan meminjam barang, selanjutnya disebut <strong>PIHAK KEDUA</strong>.</td>
            </tr>
        </table>

        <p style="margin-top:6px;">PIHAK PERTAMA menyerahkan barang inventaris madrasah kepada PIHAK KEDUA, dan PIHAK KEDUA menyatakan telah menerima barang tersebut dalam kondisi baik dengan rincian:</p>
        ...
        <p style="text-indent:0;"><strong>Ketentuan dan Syarat Peminjaman:</strong></p>
        <ol class="klausul-list">
            ...
            <li>Jangka waktu peminjaman disepakati mulai tanggal <strong><?= $tglPinjamText ?></strong> s.d. <strong><?= $tglKembaliRencanaText ?></strong>.</li>
            ...
            <li>Apabila terjadi kerusakan atau kehilangan akibat kelalaian selama masa peminjaman, PIHAK KEDUA bersedia bertanggung jawab sesuai peraturan yang berlaku di MAN 2 HSU.</li>
        </ol>

        <p>Demikian Berita Acara Serah Terima Peminjaman ini dibuat dengan sebenarnya untuk dipergunakan sebagaimana mestinya.</p>
    </div>
