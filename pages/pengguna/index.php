...
<div class="page-header">
    ...
    <a href="<?= BASE_URL ?>/pengguna/tambah" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Pengguna</a>
</div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><div class="btn-group">
                <a href="<?= BASE_URL ?>/pengguna/edit?id=<?= $u['id'] ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                <?php if ($u['id'] != $_SESSION['user_id']): ?>
                <a href="javascript:void(0)" onclick="confirmDelete('Hapus pengguna <?= htmlspecialchars($u['nama'], ENT_QUOTES) ?>?', '<?= BASE_URL ?>/pages/pengguna/hapus.php', '<?= $u['id'] ?>')" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                <?php endif; ?>
            </div></td>
        </tr>
        <?php endforeach; ?>
