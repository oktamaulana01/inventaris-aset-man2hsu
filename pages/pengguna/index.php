...
<div class="card animate-fadeInUp"><div class="card-header"><h3>Daftar Pengguna</h3></div><div class="card-body"><div class="table-wrapper">
    <table><thead><tr><th>No</th><th>Nama</th><th>Username</th><th>Role</th><th>Terdaftar</th><th>Aksi</th></tr></thead>
    <tbody>
        ...
        <tr>
            ...
            <td><div class="btn-group">
                ...
                <a href="javascript:void(0)" onclick="confirmDelete('Hapus pengguna <?= htmlspecialchars($u['nama']) ?>?', 'hapus.php?id=<?= $u['id'] ?>')" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                <?php endif; ?>
            </div></td>
        </tr>
        <?php endforeach; ?>
